...
const DataList = ({ ...props }) => {
  ...
  const [page, setPage] = useState(() => {
    ...
    return savedPage && data?.length > displayLength
  ...
  return (
    <>
      <div className="table-responsive">
        ...
        {type === "stock" && <TableStock {...props} data={datos} />}
        {type === "warehouses" && <TableWarehouses {...props} data={datos} />}
        {type === "warehouseLines" && (
          <TableWarehouseLines {...props} data={datos} />
        )}
        {type === "stockMove" && <TableStockMove {...props} data={datos} />}
        {type === "menu" && <TableMenu {...props} data={datos} />}
        {type === "cleaningJobs" && (
        ...
        {type === "assetMove" && <TableAssetMove {...props} data={datos} />}
        {type === "typeroom" && (
        ...
        {type === "notes" && <TableNotes {...props} data={datos} />}
        {type === "typeroomseason" && (
          <TableTypeRoomSeason {...props} data={datos} />
        )}
        {type === "typeroomdata" && <TableDataTypeRoom data={datos} />}
        {type === "invoicesIssued" && (
        ...
        {type === "tableDate" && <TableDate {...props} data={datos} />}
        {type === "orders" && (
        ...
        {type === "items" && (
          <TableItems {...props} data={datos} onDelete={onDelete} />
        )}
      </div>
