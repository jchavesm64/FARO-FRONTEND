...
const EditAmenities = () => {
  ...
  const { id } = useParams();
  const {
    loading: loading_amenites,
    error: error_amenites,
    data: data_amenites,
    startPolling,
    stopPolling,
  } = useQuery(OBTENER_COMODIDADES_BY_ID, {
    variables: { id: id },
    pollInterval: 1000,
  });
      ...
      <React.Fragment>
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              title="Editar tipo de comodidad"
              breadcrumbItem="Comodidad"
