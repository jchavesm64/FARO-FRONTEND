...
import { SAVE_SERVICIO_EXTERNO } from "../../../../services/ServiciosExternalService";
...
const NewExtraService = () => {
    ...
    const [insertar] = useMutation(SAVE_SERVICIO_EXTERNO);
    ...
    const onClickSave = async () => {
        try {
            ...
            const { estado, message } = data.insertarServicioExterno;
            if (estado) {
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumbs title="Editar servicio externo" breadcrumbItem="Servicio externos" breadcrumbItemUrl='/hotelsettings/externalservices' />
                    <Card className='p-4'>
                        <Row>
                        ...
                        <Row>
                            <div className="col mb-3">
                                <SpanSubtitleForm subtitle='Información del servicio externos' />
                            </div>
                        </Row >
