...
import { SAVE_TIPO_PLATILLO } from "../../../services/TipoPlatilloService";

const NewDishType = () => {
    document.title = "Platillos | FARO";

    const navigate = useNavigate();
    const [insertar] = useMutation(SAVE_TIPO_PLATILLO);
    ...
    const onClickSave = async () => {
        try {
            ...
            const { estado, message } = data.insertarTipoPlatillo;
            if (estado) {
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumbs title="Nuevo Tipo de Platillo" breadcrumbItem="Gestion de Tipos de Platillo" breadcrumbItemUrl='/dishtype' />
                    <Row>
