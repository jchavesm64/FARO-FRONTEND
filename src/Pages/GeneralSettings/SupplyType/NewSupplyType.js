...
import { SAVE_TIPO_PROVEDURIA } from "../../../services/TipoProveduriaService";
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid={true}>
                    <Breadcrumbs title="Nuevo Tipo de Proveeduría" breadcrumbItem="Gestion de Tipos de Proveeduría" breadcrumbItemUrl='/suppliertype' />
                    <Row>
                        ...
                        <div className="col-md-12 col-sm-12">
                            ...
                            <Row>
                                <div className="col-md-6 col-sm-12 mb-3">
                                    <label htmlFor="type" className="form-label">* Tipo de proveeduría</label>
