...
const BookingCheckIn = () => {
  ...
  function checkLastActiveReservation(reservations) {
    const activeReservations = reservations.filter(
      (reservation) => reservation.estado !== "CheckIn"
    );
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const { data } = await checkIn({
          variables: { id: selectedRoom.id, reserva: booking.id, huespedes },
        });
              ...
              <div className="booking-details">
                ...
                <div className="booking-info">
                  ...
                  <div className="info-item">
                    ...
                    <Badge
                      color={
                        booking.estado === "Cancelada" ? "danger" : "primary"
                      }
                    >
                      {booking.estado}
                    </Badge>
                  ...
                  <div className="info-item">
                    <strong>Tipo:</strong>{" "}
                    <Badge color="primary">{booking.tipo}</Badge>
                  </div>
                  <div className="info-item">
                        ...
                        >
                          <div className="room-info">
                            ...
                            <div className="info-item">
                              ...
                              {habitacion.habitacion.comodidades
                                .map((c) => c.nombre)
                                .join(", ")}
                            </div>
                            <div className="info-item">
                              <strong>Servicios Extra:</strong>{" "}
                              {habitacion.serviciosExtra
                                .map((s) => s.nombre)
                                .join(", ")}
                            </div>
                            <Button
            ...
            <FormGroup>
              <div className="form-check ms-3 mt-4">
                <input
                  ...
                  onClick={() => {
                    handleUseBookingClientChange();
                  }}
                />
                <label
                  htmlFor="isSameAsCustomer"
            ...
            <Row className="d-flex justify-content-between p-3 pb-0">
              <div className="col-md-12 mb-1">
                ...
                <input
                  ...
                  disabled={
                    huespedes.length >=
                    booking?.numeroPersonas.adulto +
                      booking?.numeroPersonas.ninos
                  }
