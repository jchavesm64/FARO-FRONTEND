                ...
                <Container fluid={true}>
                    <Card className="m-2 p-2 ">
                            ...
                            {roomsBooking.length ? (
                                <Row className="m-2 p-2 d-flex flex-row col-md-7 col-xl-7 justify-content-around">
                                    ...
                                    <div className="form-check ms-3 mt-2 col-md-3">
                                        ...
                                        />
                                        <label htmlFor="isServiceRoom" className="form-check-label ms-2">Servicios de tours</label>
                                    </div>
                                </Row>
                        ...
                        <div className='col-md-12 d-flex flex-row  justify-content-center'>
                            {serviceBookingCheck && (
                                <Card className='col-md-4 col-xl-4 bg-light m-2 p-2 '>
                                    <div className="col-md-12">
                                        <h3 key='titleService' className="text-center mb-4 mt-4">Servicios adicionales por reserva</h3>
                                    </div>
