...
const ToursService = ({ ...props }) => {
  ...
  const [isOpenServicePerBookingList, setIsOpenServicePerBookingList] =
    useState(false);
  const [isOpenServicePerRoomList, setIsOpenServicePerRoomList] =
    useState(false);
        ...
        <Container fluid={true}>
          <Row className="d-flex justify-content-between shadow_service rounded-5 p-4">
            <Col className="col-md-12  d-flex justify-content-center flex-column align-items-center">
              <h3 className="col mb-2">Servicios Adicionales</h3>

              {typeBooking !== "IN" && (
                <div
                  className="accordion col-md-11 col-sm-8 m-2 shadow_wizard"
                  id="booking"
                >
                  <div className="accordion-item ">
                    <h2
                      className="accordion-header"
                      id="headingAddServiceBooking"
                    >
                      <button
                        className={`service_toggle step-hover-effect_wizard accordion-button ${
                          !isOpenServicePerBooking ? "collapsed" : ""
                        }`}
                        type="button"
                        onClick={() =>
                          toggleAccordion(
                            setIsOpenServicePerBooking,
                            isOpenServicePerBooking
                          )
                        }
                      ...
                      >
                        <label className="fs-5 m-0 ms-4 span_package_color ">
                          <strong>
                            Agregar servicios adicionales por reserva
                          </strong>
                        </label>
                      </button>
                    </h2>
                      ...
                      <div className="accordion-body">
                        <div className="d-flex justify-content-center flex-wrap align-content-center">
                          <Col>
                                    ...
                                    <CardBody>
                                      ...
                                      <Row>
                                        <TabeListService
                                          ...
                                          enableAmount
                                          enableDelete
                                          actionDelete={deleteServiceBooking}
                                          enableEdit
                                          actionEdit={showModalEditService}
                                          actionAmount={updateAmountService}
                                          mainKey={"nombre"}
                                          type="perService"
                                          amount="Extra"
                                          actionCalendar={showModalCalendar}
                                          enableCalendar
                                        />
                                      </Row>
                                    </CardBody>
                            ...
                            <Row>
                              <div
                                className="accordion col-md-12 col-sm-8"
                                id="serviceBooking"
                              >
                                <div className="accordion-item">
                                  <h2
                                    className="accordion-header"
                                    id="headingServiceBooking"
                                  >
                                    <button
                                      className={`accordion-button ${
                                        !isOpenServicePerBookingList
                                          ? "collapsed"
                                          : ""
                                      }`}
                                      type="button"
                                      onClick={() =>
                                        toggleAccordion(
                                          setIsOpenServicePerBookingList,
                                          isOpenServicePerBookingList
                                        )
                                      }
                                      aria-expanded={
                                  ...
                                  <div
                                    ...
                                    className={`accordion-collapse collapse ${
                                      isOpenServicePerBookingList ? "show" : ""
                                    }`}
                                    aria-labelledby="headingServiceBooking"
                                  >
                                    <div className="accordion-body">
                                          ...
                                          <div className="col-md-11 col-sm-8 border border-secondary rounded p-1 me-2 d-flex justify-content-center flex-wrap">
                                            {extraService?.map((service) => (
                                              <div className="col-md-11 border m-2 shadow_wizard rounded p-3 d-flex justify-content-between">
                                                <div
                                                  key={`row${service.nombre}`}
                                                  className="m-0 col-md-11 p-1"
                                                >
              ...
              >
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingServiceRoom">
                    <button
                      className={`step-hover-effect_wizard accordion-button ${
                        !isOpenServicePerRoom ? "collapsed" : ""
                      }`}
                      type="button"
                      onClick={() =>
                        toggleAccordion(
                          setIsOpenServicePerRoom,
                          isOpenServicePerRoom
                        )
                      }
                    ...
                    >
                      <label className="fs-5 m-0 ms-4 span_package_color">
                        <strong>
                          Agregar servicios adicionales por habitación
                        </strong>
                      </label>
                    </button>
                  </h2>
                            ...
                            <Card className="col-md-11 col-xl-11 bg-light m-2 p-2 shadow_wizard">
                              <div className="col-md-12">
                                <h3
                                  ...
                                  className="text-center mb-2 mt-2"
                                >
                                  Servicios adicionales por habitación
                                </h3>
                              </div>
                              ...
                              {roomsBooking.length ? (
                                  ...
                                  {selectRoom ? (
                                    <Card className="p-2 shadow_wizard">
                                      <CardBody>
                                        ...
                                        <Row>
                                          <TabeListService
                                            data={extraServiceRoom}
                                            headers={["Servicio", "Precio"]}
                                            keys={["nombre", "precio"]}
                                            enableAmount={true}
                                            enableDelete={true}
                                            actionDelete={deleteServiceRoom}
                                            enableEdit={true}
                                            actionEdit={showModalEditService}
                                            actionAmount={updateAmountService}
                                            mainKey={"nombre"}
                                ...
                                <div className="d-flex justify-content-center">
                                  <h5 className="text-center">
                                    Debe haber seleccionado almenos una
                                    habitación para realizar esta acción.
                                  </h5>
                                </div>
                              )}
                            </Card>
                          ...
                          <Row>
                            ...
                            >
                              <div className="accordion-item">
                                <h2
                                  className="accordion-header"
                                  id="headingServiceRoomList"
                                >
                                  <button
                                    className={`accordion-button ${
                                      !isOpenServicePerRoomList
                                        ? "collapsed"
                                        : ""
                                    }`}
                                    type="button"
                                  ...
                                  >
                                    ...
                                    adicionales por habitación
                                  </button>
                                </h2>
                                <div
                                  id="collapseOneRoomList"
                                  className={`accordion-collapse collapse ${
                                    isOpenServicePerRoomList ? "show" : ""
                                  }`}
                                  aria-labelledby="headingServiceBooking"
                                >
                                  <div className="accordion-body">
              ...
              >
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingServiceTour1">
                    <button
                      className={`step-hover-effect_wizard accordion-button ${
                        !isOpenServiceTour ? "collapsed" : ""
                      }`}
                      type="button"
                      onClick={() =>
                        toggleAccordion(setIsOpenServiceTour, isOpenServiceTour)
                      }
                                  ...
                                  <CardBody>
                                    ...
                                    <Row>
                                      <ListInfo
                                        ...
                                        keys={["nombre", "precio"]}
                                        enableEdit={true}
                                        actionEdit={showModalEditTour}
                                        enableDelete={true}
                                        actionDelete={deleteTour}
                                        mainKey={"nombre"}
                                        secondKey={"precio"}
                                      />
                                    </Row>
                          ...
                          <Row>
                            ...
                            >
                              <div className="accordion-item">
                                <h2
                                  className="accordion-header"
                                  id="headingServiceTour3"
                                >
                                  <button
                                    className={`accordion-button ${
                                      !isOpenServiceTourList ? "collapsed" : ""
                                    }`}
                                    type="button"
                                    onClick={() =>
                                      toggleAccordion(
                                        setIsOpenServiceTourList,
                                        isOpenServiceTourList
                                      )
                                    }
                                    aria-expanded={isOpenServiceTourList}
                                    aria-controls="collapseOne"
                                  >
                                    Mostrar información acerca de los tours
                                    selecionados por reserva
                                  </button>
                                </h2>
                                <div
                                  id="collapseOneTourList"
                                  className={`accordion-collapse collapse ${
                                    isOpenServiceTourList ? "show" : ""
                                  }`}
            ...
            {extraDate.length === 0 ? (
              <ModalBody key="modalbody">
                {type !== "perRoom " && type !== "" ? (
                  <EditExtraService
                    idBooking={filter?.id}
                    updateServiceBooking={updateService}
                  />
                ) : (
                  <EditTour
                    idBooking={filter?.id}
                    updateTourBooking={updateTour}
                  />
                )}
              </ModalBody>
            ) : (
                ...
                <Card className="p-4">
                  ...
                  <Row className="d-flex justify-content-between shadow_service rounded-5 p-3">
                    ...
                    <Col className="col-md-6  d-flex justify-content-center flex-wrap">
                      <DataList
                        data={extraDate ? extraDate?.useExtra : []}
                        type="tableDate"
                        displayLength={3}
                        enableDelete={true}
                        deleteAction={deleteDate}
                      />
                    </Col>
                  </Row>
                </Card>
