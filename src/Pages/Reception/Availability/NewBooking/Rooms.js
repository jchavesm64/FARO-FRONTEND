...
const Rooms = ({ ...props }) => {
  ...
  useEffect(() => {
    setDisabledButton(roomsBooking.length === 0);
  }, [setDisabledButton, roomsBooking]);
                        ...
                        <Row className="d-flex align-items-center">
                          <div className="col-md-2 mb-3">
                            <span className="logo-lg">
                              <img
                                src="/static/media/faro-light.f23d16523144109283f2.png"
                                alt="logo-light"
                                height="25"
                                width="85"
                              />
                          ...
                          <div className="col-md-7 col-sm-12 ">
                            <p className="mb-1 mt-1">
                              Tipo Habitación:{" "}
                              <span>{type.type.nombre.slice(0, 20)}...</span>
                            </p>

                            <div className="mb-1 mt-1 col-md-12 d-flex flex-column">
                              Precio por noche:
                              {currentSeason.map((c) => (
                                <spam className="ms-3">
                                  {c.nombre}:{" "}
                                  <span>
                                    $
                                    {c.tiposHabitacion[type.type.nombre]?.price}
                                  </span>
                                </spam>
                              ))}
                            </div>
                          ...
                          <div className="col-md-3 col-sm-12 d-flex flex-column align-items-center justify-content-end">
                            <InputGroup style={{ maxWidth: "7rem" }}>
                              ...
                              <Button
                                ...
                                disabled={
                                  type.amountBooking === type.lengthAvailable ||
                                  enableRooms
                                }
                              >
                                +
                            ...
                            <p>
                              Disponibles:{" "}
                              {type.lengthAvailable - type.amountBooking}
                            </p>
                          </div>
                        </Row>
                      </CardBody>
            ...
            <Col className="col-md-5">
              <Card className="col-md-12 bg-light border ms-2 p-2 room_card_wizard">
                <div className="col-md-12">
                  <h3 key="summary" className="text-center mb-4 mt-4">
                    Habitaciones
                  </h3>
                          ...
                          {amountTypeRooms.map(
                            (type) =>
                              type.amountBooking !== 0 && (
                                <div
                                  id={`data${type.type.nombre}`}
                                  key={`data${type.type.nombre}`}
                                  className="col-md-11 border m-2 shadow_wizard rounded p-3 d-flex justify-content-between"
                                >
                                  <div
                                    id={`row${type.type.nombre}`}
                                    key={`row${type.type.nombre}`}
                                    className="m-0 col-md-11 p-1"
                                  >
                                    <label
                                      id={`label${type.type.nombre}`}
                                      key={`label${type.type.nombre}`}
                                      className="fs-4 m-0 span_package_color"
                                    >
                                    ...
                                    <div
                                      id={`card${type.type.nombre}`}
                                      key={`card${type.type.nombre}`}
                                      className="col-md-11 m-1 d-flex flex-wrap flex-column"
                                    >
                                      <label
                                        id={`rowselect${type.type.nombre}`}
                                        key={`rowselect${type.type.nombre}`}
                                        className="fs-5 m-0 ms-4 span_package_color"
                                      >
                                        <strong>
                                          Habitaciones selecionadas:
                                        </strong>{" "}
                                        <span className="fs-5 label_package_color">
                                          {type.amountBooking}
                                        </span>
